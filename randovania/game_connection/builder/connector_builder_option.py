...
from randovania.game_connection.builder.dolphin_daemon_connector_builder import DolphinDaemonConnectorBuilder
...
_CHOICE_TO_BUILDER = {
    ...
    ConnectorBuilderChoice.DOLPHIN_DAEMON: DolphinDaemonConnectorBuilder,
}
